...
if "%choice%"=="1" (
    ...
    python benchmark.py --duration 120 --plots --output quick_benchmark.json
) else if "%choice%"=="2" (
    echo Running 5-minute benchmark...
    python benchmark.py --duration 300 --plots --output standard_benchmark.json
) else if "%choice%"=="3" (
    echo Running 10-minute benchmark...
    python benchmark.py --duration 600 --plots --output extended_benchmark.json
) else if "%choice%"=="4" (
    ...
    python benchmark.py --duration !duration! --plots --output custom_benchmark.json
) else (
