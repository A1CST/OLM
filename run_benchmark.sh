...
case $choice in
    1)
        ...
        $PYTHON_CMD benchmark.py --duration 120 --plots --output quick_benchmark.json
        ;;
    2)
        echo "Running 5-minute benchmark..."
        $PYTHON_CMD benchmark.py --duration 300 --plots --output standard_benchmark.json
        ;;
    3)
        echo "Running 10-minute benchmark..."
        $PYTHON_CMD benchmark.py --duration 600 --plots --output extended_benchmark.json
        ;;
    4)
    ...
    5)
        ...
        $PYTHON_CMD benchmark.py --duration $duration --plots --output custom_benchmark.json
        ;;
    *)
